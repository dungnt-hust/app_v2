...
@section('css')
    <link  href="{{asset('admins/setting/index.css')}}" rel="stylesheet"/>
@endsection
@section('js')
                    ...
                    <div class="col-md-12">
                        <div class="btn-group">
                            <a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
                                Add setting <span class="caret"></span>
                            </a>
                        ...
                        <table class="table">
                            ...
                            @foreach($settings as $setting)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('settings.edit', ['id' => $setting->id]).'?type='.$setting->type}}" class="btn btn-default">Sửa</a>
                                        <a href=""
